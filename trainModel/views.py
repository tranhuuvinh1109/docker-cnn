...
train_data_dir = 'D:/môn học/lap_trinh_mang/CNN/docker-cnn/datasets/train'
test_data_dir = 'D:/môn học/lap_trinh_mang/CNN/docker-cnn/datasets/valid'
...
class TrainModel (APIView):
    def get(self, request):
        ...
        return Response({"message": "train done"}, status=status.HTTP_200_OK)
